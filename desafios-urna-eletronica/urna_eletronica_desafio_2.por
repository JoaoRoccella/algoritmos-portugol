 ...
 * 
 * Desafio 2
 * Crie um passo extra de confirmação para que seja preciso digitar 
 * S ou N para encerrar a votação da urna; Dica: utilize uma estrutura 
 * de decisão dentro do caso que trata a opção para encerrar a votação.
 * 
*/
 ...
 * @POSICAO-CURSOR = 2356; 
 * @PONTOS-DE-PARADA = ;
 * @SIMBOLOS-INSPECIONADOS = {encerraVotacao, 53, 3, 14};
